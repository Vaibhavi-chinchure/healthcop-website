...
// // // // // import { icons } from './logobase64.js';
...
// // // // //       const subRowHeight = 8; // Increased for better spacing
// // // // //       const lineHeight = 1; // Increased for better line separation
// // // // //       const cellPadding = 5; // Added consistent cell padding
// // // // //       const gap = 3;
// // // // //       const drawHLine = (y) => {
...
// // // // //       let page2Y = 5;
// // // // //       try {
// // // // //         doc.addImage('/images/about2.png', 'JPG', 20, page2Y, 38,27);
// // // // //       } catch (imgErr) {
...
// // // // //         ['Weight', String(laborerData.weight || ''), 'Frequent Headache', laborerData.frequent_headache || ''],
...
// // // // //         ['BP', String(laborerData.bp || ''), 'Physical Deformity', laborerData.physical_deformity || ''],
// // // // //         ['Pulse', String(laborerData.pulse || ''), 'Flat Foot', laborerData.flat_foot || ''],
// // // // //         policeRow,
...
// // // // //       const cellPadding2 = 5; // Consistent with first table
...
// // // //   const [selectedLaborer, setSelectedLaborer] = useState(null);
// // // //   const [isDetailsOpen, setIsDetailsOpen] = useState(false);
// // // //   const [message, setMessage] = useState(''); // New state for popup message
// // // //   const [messageType, setMessageType] = useState(''); // New state for message type (error/success)
// // // //   const [showMessagePopup, setShowMessagePopup] = useState(false); // New state for popup visibility
...
// // // //     return createPortal(
// // // //       <div className={`npe-message-popup npe-message-${type}`}>
// // // //         <span>{message}</span>
// // // //         <button className="npe-message-close" onClick={onClose}>
// // // //           ×
// // // //         </button>
// // // //       </div>,
// // // //       document.body
...
// // // //       handleInputChange(index, field, file);
// // // //     } else {
// // // //       showPopup("File size must be less than 10 MB", "error");
// // // //     }
// // // //   };
...
// // // //     const token = localStorage.getItem("token");
// // // //     if (!token) {
// // // //       showPopup("Please log in to submit data.", "error");
// // // //       setIsSubmitting(false);
// // // //       return;
// // // //     }
// // // //     const requiredFieldKeys = fields.filter(f => f.required).map(f => f.key);
...
// // // //     setErrors(newErrors);
// // // //     if (hasErrors) {
// // // //       showPopup("Please fill all required fields marked in red.", "error");
// // // //       setIsSubmitting(false);
// // // //       return;
// // // //     }
// // // //     if (laborers.every(l => !l.name || !l.name.trim())) {
// // // //       showPopup("Please fill at least one laborer's name to submit.", "error");
// // // //       setIsSubmitting(false);
// // // //       return;
// // // //     }
// // // //     try {
...
// // // //       if (response.ok) {
// // // //         const result = await response.json();
// // // //         showPopup(`${processedLaborers.length} laborer(s) saved successfully! Laborer IDs: ${result.laborer_ids?.join(", ") || "Generated"}`, "success");
// // // //         setIsPopupOpen(false);
// // // //         setLaborers(Array(1).fill({}));
// // // //         setNumRows(1);
// // // //         setErrors(Array(1).fill({}));
...
// // // //           errorText = errorText.substring(0, 200);
// // // //         }
// // // //         showPopup(`Error: ${errorText}`, "error");
// // // //       }
// // // //     } catch (error) {
...
// // // //         setPendingLaborers(pending);
// // // //       } else {
// // // //         showPopup("Failed to fetch laborers.", "error");
// // // //       }
// // // //     } catch (error) {
// // // //       showPopup("Error fetching laborers: " + error.message, "error");
// // // //     }
// // // //   };
...
// // // //           }
// // // //         } else {
// // // //           showPopup("Failed to fetch client data.", "error");
// // // //           return;
// // // //         }
// // // //       }
// // // //       const doc = new jsPDF();
// // // //       // ... (rest of the PDF generation code remains unchanged until the end) ...
// // // //       const date = new Date().toISOString().split('T')[0];
// // // //       const fileName = `laborer_${laborerData.laborer_id || laborerData.id}_${date}.pdf`;
// // // //       doc.save(fileName);
// // // //     } catch (error) {
// // // //       console.error("Error generating PDF:", error);
// // // //       showPopup("Error generating PDF: " + error.message, "error");
// // // //     }
// // // //   };
...
//   useEffect(() => {
//     const site = getCookie("site_id");
//     const user = getCookie("user_id");
//     if (site) setCurrentSiteId(parseInt(site, 10));
...
//     setNumRows(num);
//     if (num > laborers.length) {
//       const extra = Array(num - laborers.length).fill({});
//       setLaborers([...laborers, ...extra]);
//       setErrors([...errors, ...Array(extra.length).fill({})]);
//     } else if (num < laborers.length) {
//       setLaborers(laborers.slice(0, num));
//       setErrors(errors.slice(0, num));
//     }
...
//     const updated = [...laborers];
//     updated[idx] = { ...updated[idx], [field]: value };
//     setLaborers(updated);
//   };

//   const handleFileChange = (idx, field, e) => {
//     const file = e.target.files[0];
//     if (file && file.size <= 10 * 1024 * 1024) {
//       handleInputChange(idx, field, file);
//     } else {
//       alert("File size must be less than 10 MB");
//     }
//   };

//   /* ---------- Edit existing laborer ---------- */
//   const handleEdit = (laborer) => {
//     const camel = snakeToCamelObj(laborer);
//     camel.identificationMark1 = Array.isArray(camel.identificationMark1)
//       ? camel.identificationMark1
//       : typeof camel.identificationMark1 === "string"
//       ? JSON.parse(camel.identificationMark1)
//       : [];
//     camel.identificationMark2 = Array.isArray(camel.identificationMark2)
//       ? camel.identificationMark2
//       : typeof camel.identificationMark2 === "string"
//       ? JSON.parse(camel.identificationMark2)
//       : [];
...
//   /* ---------- SUBMIT (adds site_id from cookie) ---------- */
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     setIsSubmitting(true);
...
//     if (!currentSiteId) {
//       alert("Site information missing – please re-login.");
//       setIsSubmitting(false);
//       return;
//     }
...
//     const newErrors = laborers.map(() => ({}));
//     let hasErr = false;

//     laborers.forEach((lab, i) => {
//       requiredKeys.forEach((k) => {
//         const v = lab[k];
//         const empty =
//           k === "identificationMark1" || k === "identificationMark2"
//             ? !Array.isArray(v) || v.length === 0
//             : !v || (typeof v === "string" ? v.trim() === "" : false);
//         if (empty) {
//           newErrors[i][k] = "Required";
//           hasErr = true;
//         }
//       });
//     });
...
//     if (laborers.every((l) => !l.name?.trim())) {
//       alert("Enter at least one laborer name.");
//       setIsSubmitting(false);
//       return;
//     }

//     try {
//       const processed = laborers
//         .map((lab) => {
//           if (!lab.name?.trim()) return null;

//           const proc = camelToSnakeObj(lab);

//           /* *** ADD SITE_ID & CREATED_BY FROM COOKIES *** */
//           proc.site_id = currentSiteId;
//           proc.created_by = currentUserId || "unknown";

//           /* ---- POLICE handling ---- */
//           const polices = ["pallor", "lymphadenopathy", "icterus", "cyanosis", "edema"];
//           polices.forEach((p) => (proc[p] = "No"));
//           if (proc.polic_e && proc.polic_e !== "None") {
//             const map = {
//               Pallor: "pallor",
//               Lymphadenopathy: "lymphadenopathy",
//               Icterus: "icterus",
...
//               Edema: "edema",
//             };
//             const f = map[proc.polic_e];
//             if (f) proc[f] = "Yes";
//           }
//           delete proc.polic_e;

//           /* ---- identification marks ---- */
//           proc.identification_mark1 = JSON.stringify(
//             Array.isArray(proc.identification_mark1) ? proc.identification_mark1 : []
//           );
//           proc.identification_mark2 = JSON.stringify(
//             Array.isArray(proc.identification_mark2) ? proc.identification_mark2 : []
//           );
...
//         if (lab.heightPhobiaImage instanceof File)
//           formData.append("heightPhobiaImage", lab.heightPhobiaImage);
//         if (lab.physicalDeformityImage instanceof File)
//           formData.append("physicalDeformityImage", lab.physicalDeformityImage);
//       });

//       const resp = await fetch(
//         "https://healthcop-website-backend-1.onrender.com/api/nurse-pre-employment",
//         {
//           method: "POST",
...
//       if (resp.ok) {
//         const { laborer_ids } = await resp.json();
//         alert(
//           `${processed.length} laborer(s) saved! IDs: ${laborer_ids?.join(", ") || ""}`
//         );
//         setIsPopupOpen(false);
//         setLaborers([{}]);
//         setNumRows(1);
...
//         alert(`Error: ${txt.substring(0, 200)}`);
//       }
//     } catch (err) {
...
//   /* ---------- FETCH laborers (approved / pending) ---------- */
//   const fetchLaborers = async () => {
//     try {
//       const token = localStorage.getItem("token");
...
//         setApprovedLaborers(data.filter((l) => l.status === "approve"));
//         setPendingLaborers(data.filter((l) => l.status === "pending"));
//       }
//     } catch (e) {
//       console.error(e);
//     }
...
//           `https://healthcop-website-backend-1.onrender.com/healthcop-website-backend/api/clients`,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//             credentials: "include",
//           }
...
//             c.sites.some((s) => s.site_id === laborerData.site_id)
//           );
//           if (client) {
//             clientName = client.client_name || "";
//             const site = client.sites.find((s) => s.site_id === laborerData.site_id);
...
//       doc.setFontSize(16);
//       doc.setFont("helvetica", "bold");
//       doc.text("Form XVIII", pageW / 2, y, { align: "center" });
//       y += 10;
//       doc.setFontSize(12);
//       doc.setFont("helvetica", "normal");
//       doc.text("[See rule 250(c)]", pageW / 2, y, { align: "center" });
//       y += 15;
//       doc.setFontSize(14);
//       doc.setFont("helvetica", "bold");
//       const title = "CERTIFICATE OF MEDICAL EXAMINATION";
...
//       doc.setLineWidth(0.5);
//       doc.line((pageW - titleW) / 2, y - 3, (pageW + titleW) / 2, y - 3);
//       y += 20;

//       /* ---- Table layout (your original code – kept unchanged) ---- */
//       /* ... paste the rest of your PDF code here ... */

//       const fileName = `laborer_${laborerData.laborer_id || laborerData.id}_${new Date()
//         .toISOString()
//         .split("T")[0]}.pdf`;
//       doc.save(fileName);
//     } catch (e) {
...
//   const descriptions = {
//     Birthmark:
//       "A birthmark is an identification mark on candidates skin that has been present since birth.",
//     Scar:
//       "A scar is an identification mark left on the candidate's skin following an accident or wound that has healed.",
//     Tattoos: "Tattoos are designs or patterns made permanent by putting ink into the skin.",
//     Mole: "A mole is a small, harmless, dark spot on the skin.",
//     Freckles:
//       "Freckles are small, light-brown spots on the skin that form when melanin builds up.",
//     Dimples: "Dimples are minor dents or hollows on the face or chin.",
//     Piercings:
//       "Piercings are permanent holes or openings made in the body so jewelry, like earrings or nose rings, can be worn.",
//     "Hair Color":
//       "Hair colors that are unusual or stand out, whether they are dyed or happen naturally.",
//     "Scars from surgery": "Scars are marks left on the body after surgery.",
//     "Gap between teeth": "A space or gap between two teeth that can be seen.",
//     Wart: "A wart is a small, rough growth on the skin caused by a virus.",
//     Keloid: "A keloid is a raised scar that grows beyond the original wound.",
...
//     "Cut Mark": "A cut mark is a scar from a cutting injury.",
//     "Facial Asymmetry":
//       "Facial asymmetry is a noticeable difference in the sides of the face.",
//   };
...
//     const handleToggle = () => {
//       setOpen(!open);
//       if (!open && display.current) {
//         const r = display.current.getBoundingClientRect();
//         dropdown.current.style.position = "fixed";
//         dropdown.current.style.top = `${r.bottom}px`;
//         dropdown.current.style.left = `${r.left}px`;
//         dropdown.current.style.width = `${r.width}px`;
//         dropdown.current.style.zIndex = "10010";
//         setSearch("");
//       }
//     };

//     return (
//       <div ref={wrapper} className="npe-multiselect-wrapper">
//         <div ref={display} className="npe-selected-display" onClick={handleToggle}>
//           {value.length ? value.join(", ") : "Select marks..."}
//         </div>
//         {error && <div className="npe-error-msg">Required</div>}
//         {open &&
//           createPortal(
//             <div ref={dropdown} className="npe-dropdown-content">
//               <input
//                 type="text"
//                 placeholder="Search..."
//                 value={search}
...
//                   ))
//                 ) : (
//                   <div className="npe-no-options">No options</div>
//                 )}
//               </div>
//               <div className="npe-custom-input-wrapper">
//                 <input
...
//     { label: "Height Phobia", key: "heightPhobia", type: "select", options: ["", "Yes", "No", "Not Applicable"], disabled: (l) => l.sex === "Female", widthClass: "medium" },
//     { label: "Height Phobia Image", key: "heightPhobiaImage", type: "file", accept: "image/*", widthClass: "medium" },
//     { label: "Deformity Image", key: "physicalDeformityImage", type: "file", accept: "image/*", widthClass: "medium" },
//     { label: "Sugar Level", key: "sugarLevel", type: "number", step: "0.1", widthClass: "narrow" },
...
//   const filteredApproved = approvedLaborers.filter(
//     (l) =>
//       l.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       String(l.laborer_id).includes(searchTerm)
//   );
...
//       <div className="npe-header">
//         <h1 className="npe-title">Pre-Employment Dashboard</h1>
//         <button className="npe-open-form-button" onClick={() => setIsPopupOpen(true)}>
//           Enter Laborer Data
//         </button>
//       </div>
...
//         <div className="npe-tabs">
//           <button
//             className={activeTab === "approved" ? "npe-tab-active" : ""}
//             onClick={() => setActiveTab("approved")}
//           >
//             Approved Laborers
//           </button>
//           <button
//             className={activeTab === "pending" ? "npe-tab-active" : ""}
...
//                     <td>{l.laborer_id}</td>
//                     <td>
//                       <button onClick={() => openDetailsModal(l)}>View Details</button>
//                     </td>
//                     <td>
...
//             {/* Show site from cookie */}
//             <div className="npe-site-info" style={{ margin: "8px 0", fontWeight: 600 }}>
//               Site ID (auto-filled from cookie): <strong>{currentSiteId ?? "—"}</strong>
//             </div>
...
//                         <div
//                           key={i}
//                           className={`npe-table-cell npe-${f.widthClass}`}
//                           title={f.label}
//                         >
//                           {f.label}
//                         </div>
...
//                     {laborers.map((lab, idx) => (
//                       <div key={idx} className="npe-table-row">
//                         <div className="npe-table-cell">Laborer {idx + 1}</div>
//                         {fields.map((f, fi) => (
//                           <div
//                             key={fi}
//                             className={`npe-table-cell npe-${f.widthClass} ${
//                               f.type === "multiselect" ? "npe-multiselect-cell" : ""
//                             }`}
//                           >
//                             {f.type === "select" ? (
//                               <select
//                                 value={lab[f.key] ?? ""}
//                                 onChange={(e) => handleInputChange(idx, f.key, e.target.value)}
//                                 disabled={f.disabled?.(lab)}
//                                 className="npe-select-field"
//                               >
...
//                             ) : f.type === "multiselect" ? (
//                               <MultiSelectField
//                                 value={Array.isArray(lab[f.key]) ? lab[f.key] : []}
//                                 options={f.options}
//                                 onChange={(sel) => handleInputChange(idx, f.key, sel)}
...
//                                 type="file"
//                                 accept={f.accept}
//                                 onChange={(e) => handleFileChange(idx, f.key, e)}
//                                 className="npe-file-field"
//                               />
//                             ) : (
//                               <input
...
//                               <div className="npe-error-msg">Required</div>
//                             )}
//                             {f.key === "otherHealthInfo" && lab.otherHealthInfo === "Yes" && (
//                               <textarea
//                                 value={lab.otherHealthDetails ?? ""}
//                                 onChange={(e) =>
//                                   handleInputChange(idx, "otherHealthDetails", e.target.value)
//                                 }
//                                 placeholder="Provide details"
//                                 className="npe-textarea-field"
//                               />
...
//             <h3>Details for {selectedLaborer?.name}</h3>
//             <div className="npe-details-grid">
//               {Object.entries(selectedLaborer ?? {}).map(([k, v]) => (
//                 <div key={k}>
